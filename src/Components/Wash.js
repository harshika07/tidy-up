        ...
        const response = db
          ...
          .onSnapshot((querySnapshot) => {
            ...
            querySnapshot.forEach((doc) => {
              console.log(doc);
              if (doc.data().location === "wash") {
                console.log("wash found");
                getWashFromFirebase.push({
                  ...doc.data(), //spread operator
                  id: doc.id, // `id` given to us by Firebase
                });
              }
              console.log("reached in wash");
            });
            setOrders(getWashFromFirebase);
            console.log(getWashFromFirebase);
            setLoading(false);
          });
